        ...
        child: Row(
          ...
          children: <Widget>[
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child: Text(document.data['texto'],
                      style: TextStyle(
                          fontSize: 15,
                          color: Colors.white
                      ),
            ...
            Container(
              ...
              child: Icon(Icons.account_circle, color: Colors.pink,),
            ),
          ],
        ),
      ),
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Icon(Icons.add_circle, color: Colors.pink,),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.all(4.0),
                                        child: Icon(Icons.attach_file, color: Colors.pink,),
                                      ),
                                      Flexible(
                                        child: Container(
                                          height: 35,
...
void insertar(String mensaje) async {
  await bd.collection("chat").add({'texto': mensaje});
}
